    ...
    case $opt in
        l)
            ...
            for img in $imgs; do
                ...
                \../imageTool $img "/home/andre/Desktop/UA/2023_24/1_SEMESTRE/AED/proj1/trabalho1-112974-113170/nossosTestes/VERYBIG_10000x10000.pgm" locate >>tables/LocateTable1.txt
            done
